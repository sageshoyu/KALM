...
def rrt(start, goal_sample, distance_fn, sample_fn, extend_fn, collision_fn, goal_test=lambda q: False, goal_probability=0.2, max_iterations=RRT_ITERATIONS, max_time=INF):
    """
