...
from .utils import INF, RRT_ITERATIONS, elapsed_time, irange
...
def rrt_connect(start, goal, distance_fn, sample_fn, extend_fn, collision_fn, max_iterations=RRT_ITERATIONS, max_time=INF, **kwargs):
    """
...
def birrt(start, goal, distance_fn, sample_fn, extend_fn, collision_fn, **kwargs):
    ...
    solutions = random_restarts(rrt_connect, start, goal, distance_fn, sample_fn, extend_fn, collision_fn, max_solutions=1, **kwargs)
    if not solutions:
        return None
    return solutions[0]
