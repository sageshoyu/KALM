...
def smooth_path_old(path, extend_fn, collision_fn, cost_fn=None, max_iterations=50, max_time=INF, verbose=False, **kwargs):
    """
    ...
    for iteration in irange(max_iterations):
        ...
        if verbose:
            ...
            print("Iteration: {} | Waypoints: {} | Cost: {:.3f} | Time: {:.3f}".format(iteration, len(smoothed_path), cost, elapsed_time(start_time)))
...
def smooth_path(path, extend_fn, collision_fn, distance_fn=None, cost_fn=None, sample_fn=None, max_iterations=100, max_time=INF, converge_time=INF, verbose=False, print_frequency=10):
    """
    ...
    for iteration in irange(max_iterations):
        ...
        if verbose and (print_frequency is not None) and (iteration % print_frequency == 0):
            ...
            print("Iteration: {} | Waypoints: {} | Cost: {:.3f} | Elapsed: {:.3f} | Remaining: {:.3f}".format(iteration, len(waypoints), cost, elapsed_time(start_time), max_time - elapsed_time(start_time)))
