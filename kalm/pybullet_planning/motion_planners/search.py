...
def best_first(start, goal, distance_fn, neighbors_fn, collision_fn, max_iterations=INF, max_time=INF, priority=lexicographic):  # TODO - put start and goal in neighbors_fn
    """
    :param start: Start configuration - conf
    :param goal: End configuration - conf
